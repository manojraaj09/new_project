...
class ChickenpoxPage extends StatelessWidget {
  const ChickenpoxPage({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color(0xFFd9e5fd), borderRadius: BorderRadius.circular(20)),
                  child: Row(
                    children: [
                      Container(
                          height: 100,
