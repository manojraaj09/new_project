...
import 'advance/doctorhomevisit.dart';
import 'servise.dart';

class DoctorHome extends StatefulWidget {
  const DoctorHome({Key? key, required List this.search}) : super(key: key);
  final List search;
...
class _DoctorHomeState extends State<DoctorHome> {
 ...
 getdata() async{
   ...
   var response = await http.post(url2, body: allarr);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) =>  DoctorHomeVisit (name: [],)));
          },
          child: const Icon(
            Icons.arrow_back,
            color: Colors.white,
